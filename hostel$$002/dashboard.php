...
// echo "<script>alert('SESSION blocked, Please login again');</script>"; 
						...
						<div class="row">
							<div class="col-md-12">
								<div class="row">
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light" style="background-color: rgb(0, 177, 230);">
												<div class="stat-panel text-center">
...
<p> Design <a href="https://kayosoft.com/">Luac</p>
</footer> </div>
