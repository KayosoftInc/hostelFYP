...
<?php
//************Feel the magic***********
//SAFE and WORKING SOLUTION (latest version at: Export.php + Import.php )

EXPORT_TABLES("localhost","root","","hostel"); 
//or add 5th parameter(array) of specific tables: array("mytable1","mytable2","mytable3")
                                                     
//kalfaster web solutions
function EXPORT_TABLES($host,$user,$pass,$name,  $tables=false, $backup_name=false ){
    ...
    $backup_name = $backup_name ? $backup_name : $name."___"."Date(".date('d-m-Y').")".".sql";
...
//This is the complete code to saving the database name and date
//$name."___(".date('H-i-s')."_".date('d-m-Y').")__rand".rand(1,11111111).".sql"; 
?>