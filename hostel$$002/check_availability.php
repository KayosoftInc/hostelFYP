...
// $room ="SELECT * FROM registration WHERE roomno='facebook'";
//                 $result=mysqli_query($con,$sql);
  $sql="SELECT * FROM rooms WHERE room_no ='$roomno'";
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                               ...
                               echo "<span style='color:red'>$avail. Seats available.</span>";
} else {
	echo "<span style='color:red'>All Seats are fully occupied</span>";
}  
